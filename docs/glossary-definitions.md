...
attribute:Administrative Validity Period of a PID or Attestation
...
component:Authorisation Server
...
repository:Catalogue of Attributes
:  A digital repository of attributes that is maintained and published online by the Commission.

repository:Catalogue of Schemes for the Attestation of Attributes
...
data format:Concise Binary Object Representation (CBOR)
:  The binary serialisation format used for mdoc transfers.

specification:Concise Data Definition Language (CDDL)
:  The language to define CBOR structures (e.g., `tstr`, `uint`, `bstr`, `tdate`).

entity:Conformity Assessment Body (CAB)
...
mechanism:Demonstrating Proof of Possession (DPOP)
...
data object:Electronic Attestation of Attributes (EAA)
:  An attestation in electronic form that allows attributes to be authenticated.

data object:Electronic Attestation of Attributes Issued by or on Behalf of a Public Sector Body (PuB-EAA)
...
certificate:Electronic Certificate of Conformity (ECOC)
:  Manufacturer’s electronic certificate; selected entries are mapped into EU‑MVRC.

specification:Electronic Identification Scheme
...
data object:Electronic Signature
:  Data in electronic form which is attached to or logically associated with other data in electronic form and which is used by the signatory to sign.

policy:Embedded Disclosure Policy (EDP)
...
specification:High Assurance Interoperability Profile (HAIP)
...
component:Holder Wallet Unit
:  A Wallet Unit used by a Holder.

entity:Issuing Authority/Certificate Authority (IACA)
:  The issuing authority/CA used in the MDL/MVRC trust infrastructure under ISO (may be shared with MDL or set up separately).

specification:Internet Assigned Numbers Authority JSON Web Token (IANA JWT) Claims
...
entity:National Accreditation Bodies (NAB)
...
entity:Official Journal of the European Union (OJEU)
...
mechanism:Proof Key for Code Exchange (PKCE)
...
mechanism:Presentation Request
...
entity:Provider of Person Identification Data (PID Provider)
...
entity:Provider of Wallet-Relying Party Access Certificates (Access Certificate Authority, Access CA)
...
entity:Provider of Wallet-Relying Party Registration Certificates
...
component:Qualified Electronic Signature (QES)
...
component:Qualified Electronic Signature Creation Device (QSCD)
...
entity:Qualified Electronic Signature Remote Creation Provider
...
entity:Qualified Trust Service Provider (QTSP)
...
entity:Registrar (of Wallet-Relying Parties)
...
component:Relying Party Instance
...
entity:Relying Party Intermediary (RPI)
:  A Relying Party that offers services to other (intermediated) Relying Parties to, on their behalf, connect to Wallet Units and request the User attributes that these intermediated Relying Parties need.

specification:Remote Flow
:  Remote presentation protocol (same‑device or cross‑device).

specification:Request Object
...
policy:Scheme for the Attestation of Attributes
...
data format:Selective Disclosure Java Web Token Verifiable Credential (SD‑JWT VC)
...
mechanism:Strong User Authentication
...
data object:Strong User Authentication (SUA) Attestation
...
attribute:Technical validity period (of a PID or Attestation)
...
component:Verifier Wallet Unit
:  A Wallet Unit used by a Verifier.

specification:W3C Verifiable Credentials Data Model v2.0 (W3C VCDM v2.0)
:  A family of specifications for VC data models.

component:Wallet Instance (WI)
...
data object:Wallet Instance Attestation (WIA)
...
entity:Wallet Provider (WP)
:  A natural or legal person who provides Wallet Solutions.

entity:Wallet-Relying Party (WRP)
...
data object:Wallet Unit Attestation (WUA)
