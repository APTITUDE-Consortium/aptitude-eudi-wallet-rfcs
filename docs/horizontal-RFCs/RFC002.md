...
**APT-PRES-WALLET-14**  
Release claims not requested by the <roles:Verifier>, unless explicitly authorised by the <roles:User> and permitted by the applicable profile.
...
Implementations SHOULD ensure that the <roles:User> can distinguish the intended <roles:Verifier> or service context before approving release.
